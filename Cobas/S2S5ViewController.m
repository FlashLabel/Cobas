...
#import "S2S5ViewController.h"
#import "FlipViewController.h"

@interface S2S5ViewController ()
...
@implementation S2S5ViewController
...
- (IBAction)button1Pressed:(UIButton *)sender
{
    if(sender.tag)
    {
        ...
        [self.anim1Button setBackgroundImage:[UIImage imageNamed:@"S2S5Anim1"] forState:UIControlStateNormal];
    ...
    else 
    {
        ...
        [self.anim1Button setBackgroundImage:[UIImage imageNamed:@"S2S5Anim1Back"] forState:UIControlStateNormal];
        [UIView commitAnimations];
    }
}
...
- (IBAction)button2Pressed:(UIButton *)sender
{
    if(sender.tag)
    {
        ...
        [self.anim2Button setBackgroundImage:[UIImage imageNamed:@"S2S5Anim2"] forState:UIControlStateNormal];
        [UIView commitAnimations];
    }
    else 
    {
        ...
        [self.anim2Button setBackgroundImage:[UIImage imageNamed:@"S2S5Anim2Back"] forState:UIControlStateNormal];
        [UIView commitAnimations];
    }
}
...
- (IBAction)button3Pressed:(UIButton *)sender
{
    if(sender.tag)
    {
        ...
        [self.anim3Button setBackgroundImage:[UIImage imageNamed:@"S2S5Anim3"] forState:UIControlStateNormal];
        [UIView commitAnimations];
    }
    else 
    {
        ...
        [self.anim3Button setBackgroundImage:[UIImage imageNamed:@"S2S5Anim3Back"] forState:UIControlStateNormal];
        [UIView commitAnimations];
    }
}
