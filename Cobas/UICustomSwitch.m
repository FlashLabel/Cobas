...
{
	if ((self=[super initWithFrame:CGRectMake(rect.origin.x,rect.origin.y,153,24)]))
	{
...
-(void)awakeFromNib
{
	...
	[self setThumbImage:[UIImage imageNamed:@"imageTr1"] forState:UIControlStateNormal];
    //[self setThumbImage:[UIImage imageNamed:@"imageTr"] forState:UIControlStateHighlighted];
	[self setMinimumTrackImage:[UIImage imageNamed:@"imageBg2"] forState:UIControlStateNormal];
	[self setMaximumTrackImage:[UIImage imageNamed:@"imageBg1"] forState:UIControlStateNormal];
...
//	self.clippingView = [[UIView alloc] initWithFrame:CGRectMake(0, -1, 153, 24)];
...
//	NSString *leftLabelText = NSLocalizedString(@"","Custom UISwitch ON label. If localized to empty string then I/O will be used");
...
//	
//	
//	NSString *rightLabelText = NSLocalizedString(@"","Custom UISwitch OFF label. If localized to empty string then I/O will be used");
//	if ([rightLabelText length] == 0)	
//	{
//		rightLabelText = @"";	// use helvetica uppercase o to be a 0. 
//	}
//	
...
- (void)setOn:(BOOL)turnOn animated:(BOOL)animated;
{
	...
	{
		self.value = 1.0;
        [self setThumbImage:[UIImage imageNamed:@"imageTr2"] forState:UIControlStateNormal];
	}
	else 
	{
		self.value = 0.0;
