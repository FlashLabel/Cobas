...
#import "S5S7ViewController.h"

@interface S5S7ViewController ()
...
@implementation S5S7ViewController
...
- (void)startSlideAnimation
{
    ...
    animationLeft.fromValue = [NSNumber numberWithFloat:DEGREES_TO_RADIANS(5)];
    animationLeft.toValue = [NSNumber numberWithFloat:DEGREES_TO_RADIANS(0)];
...
- (void)rezetSlideAnimation
{
    ...
    CGAffineTransform rotateRightTransform = CGAffineTransformMakeRotation(DEGREES_TO_RADIANS(5));
    [self.animView.layer setAffineTransform:rotateRightTransform];
}
